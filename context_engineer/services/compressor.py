...
from ..utils.context_utils import extract_key_info, summarize_content, extract_entities
...
class AbstractiveCompressor(BaseCompressor):
    ...
    def compress(self, content: str, target_tokens: int, **kwargs) -> CompressionResult:
        ...
        # Use summarization
        summary = summarize_content(content, target_ratio=target_ratio, preserve_keywords=True)
...
class Compressor:
    ...
    def __init__(self, tokenizer_service: Optional[TokenizerService] = None):
        ...
        self.compressors = {
            ...
            "task_summary": ExtractiveCompressor(self.tokenizer),  # Alias for extractive
            "aggressive_extract": ExtractiveCompressor(self.tokenizer)  # More aggressive extraction
        }
    ...
    def compress_with_fallback(self,
                              content: str,
                              target_tokens: int,
    ...
    def batch_compress(self,
                      ...
                      method: str = "extractive",
                      **kwargs) -> Dict[str, CompressionResult]:
        """
    ...
    def get_compression_stats(self, results: Dict[str, CompressionResult]) -> Dict[str, Any]:
        """
        ...
        stats = {
            ...
            "methods_used": list(set(result.method_used for result in results.values())),
            "section_stats": {}
        }
    ...
    def get_compressor_info(self, method: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "type": "extractive" if "extract" in method else "abstractive" if "abstract" in method else "truncation"
        }